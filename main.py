...
button_of_FFMQOG = Button(frame, text="FFMQOG", command=lambda:
                          Display("Forestry, fishing, mining, quarrying, oil and gas"), padx=25)
...
button_of_wholesale = Button(frame, text="Wholesale and retail trade", command=lambda:
                             Display("Wholesale and retail trade"), padx=25)
...
button_of_edicational_services = Button(frame, text="Education", command=lambda:
                                        Display("Educational services"), padx=25)
button_of_edicational_services.grid(row=0, column=5)

button_of_health_care = Button(frame, text="Health care and social assistance", command=lambda:
                               Display("Health care and social assistance"), padx=25)
